...
<head>
  ...
  <title>Digital Marketing | VM Technology</title>
      ...
      <ul class="menu">
        ...
        <li class="services-dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="services-dropdown">
              <a href="digital-marketing.html">Technology</a>
              <ul class="submenu">
  ...
  <main class="training-section">
    ...
    <div class="training-cards">
      <div class="training-card">
        <h3>SEO</h3>
        <p>Rank higher on search engines and drive organic traffic through expert Search Engine Optimization strategies.</p>
      </div>
      <div class="training-card">
        <h3>SEM</h3>
        <p>Run targeted paid advertising like Google Ads to increase your brand visibility and traffic.</p>
      </div>
      <div class="training-card">
        <h3>Social Media & Email</h3>
        <p>Engage your audience on social media platforms and via personalized email marketing campaigns.</p>
      </div>
      <div class="training-card">
        <h3>E-Commerce Marketing</h3>
        <p>Boost conversions and optimize your presence on online marketplaces like Amazon and Flipkart.</p>
      </div>
      <div class="training-card">
        <h3>AdWords</h3>
        <p>Maximize click-through and conversion rates with smart and effective Google AdWords campaigns.</p>
      </div>
      <div class="training-card">
        <h3>Lead Generation</h3>
        <p>Implement strategic funnels and techniques to capture and nurture quality leads for your business.</p>
      </div>
    </div>
  </main>
