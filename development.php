...
<head>
  ...
  <title>Development Services | VM Technology</title>
      ...
      <ul class="menu">
        ...
        <li class="services-dropdown">
          ...
          <ul class="dropdown-menu">
            <li class="services-dropdown">
              <a href="development.html">Technology</a>
              <ul class="submenu">
  ...
  <main>
    <section class="training-section">
      ...
      <div class="training-cards">
        ...
        <div class="training-card" id="web-app">
          <h3>Web App Development</h3>
          <p>Custom web apps using React, Angular, Django, and other modern frameworks.</p>
        </div>

        <div class="training-card" id="mobile-app">
          <h3>Mobile App Development</h3>
          <p>iOS and Android apps developed with Flutter, React Native, and native tools.</p>
        </div>
